...
export declare class MCSManagerClient {
    ...
    get baseURL(): string;
    getOverview(): Promise<import("axios").AxiosResponse<import("@/utils/request").Response<import("./types/overview").Overview>, any>>;
    ...
    }): Promise<import("axios").AxiosResponse<import("@/utils/request").Response<boolean>, any>>;
}
